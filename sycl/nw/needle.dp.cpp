...
sycl::queue &q_ct1 = dev_ct1.in_order_queue();
    ...
    size = max_cols * max_rows;
        ...
        q_ct1.memcpy(referrence_cuda, referrence, sizeof(int) * size);
 ...
 */
                q_ct1.submit([&](sycl::handler &cgh) {
                        /*
		    DPCT1101:16: 'BLOCK_SIZE+1'
                         * expression was replaced with a value. Modify the code
                         * to use the original expression, provided in comments,
                         * if it is correct.
		    */
                        /*
		    DPCT1101:17: 'BLOCK_SIZE+1'
                         * expression was replaced with a value. Modify the code
                         * to use the original expression, provided in comments,
                         * if it is correct.
		    */
                        sycl::local_accessor<int, 2> temp_acc_ct1(
                            sycl::range<2>(BLOCK_SIZE+1,
                                           BLOCK_SIZE+1),
                            cgh);
                        /*
		    DPCT1101:18: 'BLOCK_SIZE' expression
                         * was replaced with a value. Modify the code to use the
                         * original expression, provided in comments, if it is
                         * correct.
		    */
                        /*
		    DPCT1101:19: 'BLOCK_SIZE' expression
                         * was replaced with a value. Modify the code to use the
                         * original expression, provided in comments, if it is
                         * correct.
		    */
                        sycl::local_accessor<int, 2> ref_acc_ct1(
                            sycl::range<2>(BLOCK_SIZE,
                                           BLOCK_SIZE),
                            cgh);
 ...
 */
                q_ct1.submit([&](sycl::handler &cgh) {
                        /*
		    DPCT1101:20: 'BLOCK_SIZE+1'
                         * expression was replaced with a value. Modify the code
                         * to use the original expression, provided in comments,
                         * if it is correct.
		    */
                        /*
		    DPCT1101:21: 'BLOCK_SIZE+1'
                         * expression was replaced with a value. Modify the code
                         * to use the original expression, provided in comments,
                         * if it is correct.
		    */
                        sycl::local_accessor<int, 2> temp_acc_ct1(
                            ...
                            cgh);
                        /*
		    DPCT1101:22: 'BLOCK_SIZE' expression
                         * was replaced with a value. Modify the code to use the
                         * original expression, provided in comments, if it is
                         * correct.
		    */
                        /*
		    DPCT1101:23: 'BLOCK_SIZE' expression
                         * was replaced with a value. Modify the code to use the
                         * original expression, provided in comments, if it is
                         * correct.
		    */
...
//#define TRACEBACK
	...
	fclose(fpo);
        ...
        dpct::dpct_free(referrence_cuda, q_ct1);
        dpct::dpct_free(matrix_cuda, q_ct1);
