...
void cuda_compute_flux(int nelr, int *elements_surrounding_elements,
                       ...
                       const sycl::nd_item<3> &item_ct1,
                       double const *ff_variable,
                       sycl::double3 const *ff_flux_contribution_momentum_x,
                       sycl::double3 const *ff_flux_contribution_momentum_y,
                       sycl::double3 const *ff_flux_contribution_momentum_z,
                       sycl::double3 const *ff_flux_contribution_density_energy)
{
                        ...
                        cgh.parallel_for(
                            ...
                            [=](sycl::nd_item<3> item_ct1) {
                                    cuda_compute_flux(
                                        ...
                                        normals, variables, fluxes, item_ct1,
                                        ff_variable_ptr_ct1,
...
int main(int argc, char** argv)
{
	...
	// CUDA_SAFE_CALL(cudaGetDeviceProperties(&prop, dev));
        ...
        /*
	DPCT1093:60: The "0" device may be not the one intended for use.
