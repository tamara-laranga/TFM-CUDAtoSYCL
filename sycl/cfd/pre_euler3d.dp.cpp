...
static dpct::constant_memory<sycl::float3, 1> ff_fc_momentum_x(1);
static dpct::constant_memory<sycl::float3, 1> ff_fc_momentum_y(1);
static dpct::constant_memory<sycl::float3, 1> ff_fc_momentum_z(1);
static dpct::constant_memory<sycl::float3, 1> ff_fc_density_energy(1);

SYCL_EXTERNAL void cuda_initialize_variables(int nelr, float *variables,
                                             const sycl::nd_item<3> &item_ct1,
                                             float const *ff_variable)
{
...
void cuda_compute_flux(int nelr, int *elements_surrounding_elements,
                       ...
                       float *fc_momentum_y, float *fc_momentum_z,
                       float *fc_density_energy, float *fluxes,
                       const sycl::nd_item<3> &item_ct1,
                       float const *ff_variable,
                       sycl::float3 const *ff_fc_momentum_x,
                       sycl::float3 const *ff_fc_momentum_y,
                       sycl::float3 const *ff_fc_momentum_z,
                       sycl::float3 const *ff_fc_density_energy)
{
...
int main(int argc, char** argv)
{
	...
	const char* data_file_name = argv[1];
        ...
        /*
	DPCT1093:29: The "0" device may be not the one intended for use.
