...
void cuda_compute_flux(int nelr, int *elements_surrounding_elements,
                       ...
                       const sycl::nd_item<3> &item_ct1,
                       float const *ff_variable,
                       sycl::float3 const *ff_flux_contribution_momentum_x,
                       sycl::float3 const *ff_flux_contribution_momentum_y,
                       sycl::float3 const *ff_flux_contribution_momentum_z,
                       sycl::float3 const *ff_flux_contribution_density_energy)
{
...
int main(int argc, char** argv)
{
  printf("WG size of kernel:initialize = %d, WG size of kernel:compute_step_factor = %d, WG size of kernel:compute_flux = %d, WG size of kernel:time_step = %d\n", BLOCK_SIZE_1, BLOCK_SIZE_2, BLOCK_SIZE_3, BLOCK_SIZE_4);
	...
	const char* data_file_name = argv[1];
        ...
        /*
	DPCT1093:51: The "0" device may be not the one intended for use.
