...
void master(fp timeinst, fp *initvalu, fp *parameter, fp *finavalu, fp *com,
 ...
 sycl::queue &q_ct1 = dev_ct1.in_order_queue();
	...
	d_com_mem = 3 * sizeof(fp);
        ...
        q_ct1.memcpy(d_initvalu, initvalu, d_initvalu_mem);
	...
	*/
        q_ct1.parallel_for(sycl::nd_range<3>(blocks * threads, threads),
                           [=](sycl::nd_item<3> item_ct1) {
                                   kernel(timeinst, d_initvalu, d_finavalu,
                                          d_params, d_com, item_ct1);
                           });

        q_ct1.memcpy(finavalu, d_finavalu, d_finavalu_mem);
