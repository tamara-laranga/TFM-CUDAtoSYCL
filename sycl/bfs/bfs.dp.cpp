...
////////////////////////////////////////////////////////////////////////////////
//Apply BFS on a Graph using SYCL
////////////////////////////////////////////////////////////////////////////////
void BFSGraph( int argc, char** argv)
{
	...
	do
	{
		...
		*/
                q_ct1.submit([&](sycl::handler &cgh) {
                        int no_of_nodes_ct6 = no_of_nodes;
		...
		*/
                q_ct1.submit([&](sycl::handler &cgh) {
                        int no_of_nodes_ct4 = no_of_nodes;
...
#endif
        dpct::dpct_free(d_graph_nodes, q_ct1);
        dpct::dpct_free(d_graph_edges, q_ct1);
        dpct::dpct_free(d_graph_mask, q_ct1);
        dpct::dpct_free(d_updating_graph_mask, q_ct1);
        dpct::dpct_free(d_graph_visited, q_ct1);
        dpct::dpct_free(d_cost, q_ct1);
