...
/*
DPCT1110:0: The total declared local variable size in device function kernel
 * exceeds 128 bytes and may cause high register pressure. Consult with your
 * hardware vendor to find the total register size available and adjust the
 * code, or use smaller sub-group size to avoid high register pressure.
*/
void kernel(const sycl::nd_item<3> &item_ct1,
            params_common_change d_common_change, params_common d_common,
            params_unique const *d_unique, float *in_partial_sum,
            float *in_sqr_partial_sum, float &in_final_sum,
            float &in_sqr_final_sum, float &denomT, float *par_max_val,
            int *par_max_coo, float *d_in_mod_temp) {
	...
	if(d_common_change.frame_no == 0){
		...
		// pointers to: current template for current point
                d_in = const_cast<float *>(&d_unique[bx].d_T[d_unique[bx].in_pointer]);
	...
	if(d_common_change.frame_no != 0){
		...
		*/
                /*
		DPCT1065:36: Consider replacing
		...
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:2: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:37: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		...
		*/
                /*
		DPCT1065:38: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		...
		*/
                /*
		DPCT1065:39: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:5: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:40: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:6: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:41: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//==================================================
                ...
                /*
		DPCT1118:7: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:42: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//==================================================
                ...
                /*
		DPCT1118:8: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:43: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:9: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:44: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:10: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:45: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//==================================================
                ...
                /*
		DPCT1118:11: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:46: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//======================================================================================================================================================
                ...
                /*
		DPCT1118:12: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:47: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:13: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:48: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//==================================================
                ...
                /*
		DPCT1118:14: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:49: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:15: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:50: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:16: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:51: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//==================================================
                ...
                /*
		DPCT1118:17: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:52: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:18: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:53: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:19: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:54: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//==================================================
                ...
                /*
		DPCT1118:20: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:55: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//======================================================================================================================================================
                ...
                /*
		DPCT1118:21: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:56: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:22: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:57: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:23: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		...
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:24: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:59: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:25: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:60: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:26: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:61: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:27: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		...
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:28: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:63: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:29: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:64: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//======================================================================================================================================================
                ...
                /*
		DPCT1118:30: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:65: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//======================================================================================================================================================
                ...
                /*
		DPCT1118:31: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:66: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//======================================================================================================================================================
                ...
                /*
		DPCT1118:32: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:67: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//====================================================================================================
                ...
                /*
		DPCT1118:33: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:68: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
		*/
		...
		//======================================================================================================================================================
                ...
                /*
		DPCT1118:34: SYCL group functions and algorithms
                 * must be encountered in converged control flow. You may need
                 * to adjust the code.
		*/
                /*
		DPCT1065:69: Consider replacing
                 * sycl::nd_item::barrier() with
                 * sycl::nd_item::barrier(sycl::access::fence_space::local_space)
                 * for better performance if there is no access to global
                 * memory.
